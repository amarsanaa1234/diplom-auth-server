...
public class Tools {
    ...
    public static final List<String> RE_SEND_TRAN_TYPE = Arrays.asList(PRE_SALARY, SALARY, VACATION);
    ...
    public static final String pensionDtAccountType = "MOF_PENSION"; // Тэтгэмж
...
//            "25", "28", "29", "31", "43", "08", "51", "71"));
    public static List<String> listCalcInsuranceType = new ArrayList<>(Arrays.asList("20", "06", "17", "21", "38", "39", "41", "42", "25", "28", "29", "31", "43", "08", "51", "71",
            "20002", "06002", "06012", "17002", "21002", "38002", "39002", "39012", "41002", "41012", "42002", "25002", "28002", "29002", "31002", "08002", "51002", "61001","71002"));
...
//    public static List<String> listNotCalcNDConfigCode = new ArrayList<>(Arrays.asList("06", "17", "20", "41", "61", "68", "71"));
    public static List<String> listNotCalcNDConfigCode = new ArrayList<>(Arrays.asList("06", "17", "20", "41", "61", "68", "71",
            "20002", "06002", "06012", "17002", "21002", "38002", "39002", "39012", "41002", "41012", "42002", "25002", "28002", "29002", "31002", "51002", "61001","71002", "74002"));
    // Гэрээт ажилтан учир үйлдвэрлэлийн осол бодохгүй, гэрээ дээр нь тусгагдсан байдаг гэнэ. - Болортуяа 04-01 калл хийж хэлэв.
    public static List<String> listNotCalcFANDConfigCode = new ArrayList<>(Arrays.asList("11001", "02001", "08012", "40001", "69001"));
    ...
    // (Хөгжлийн бэрхшээлтэй эсэх ТИЙМ, ХХОАТ төлөх эсэх ҮГҮЙ НДШ-ийн төрлүүд)
    public static List<String> listComplicatedNDConfigCode = new ArrayList<>(Arrays.asList("69001", "70001", "70011"));
    ...
    public static BigDecimal step1Amount = new BigDecimal("10000000");
    public static BigDecimal step2Amount = new BigDecimal("15000000");
    public static BigDecimal step3Amount = new BigDecimal("20000000");
    ...
    public static class BigDecimalFilter {
        @Override
        public boolean equals(Object obj) {
            return obj == BigDecimal.ZERO;
        }
    }

    private static BigDecimal getNDSHMax(Long year) {
